...
- Always use Red Hat Hardened Images from https://images.redhat.com - Example: `registry.access.redhat.com/hi/postgresql:latest`
...
- Always set the starting sequence values - ALTER SEQUENCE customer_customer_id_seq RESTART 1000000000;
